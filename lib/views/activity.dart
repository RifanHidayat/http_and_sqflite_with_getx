...
class ActivityPage extends StatefulWidget {
  final status;
  const ActivityPage({super.key, required this.status});
...
class _ActivityPageState extends State<ActivityPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      activityController.activeNik.value = widget.status.toString();
                        ...
                        children: List.generate(
                          ...
                          return Padding(
                              ...
                              child: ListDataActivities(
                                ...
                                onTapEdit: () {
                                  activityController.dropdownValue.value=data.nik.toString();
                                ...
                                child: Padding(
                                    ...
                                    child: Obx(() {
                                      return DropdownButton(
                                        ...
                                        onChanged: (value) {
                                          activityController.dropdownValue
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2(
                            ...
                            items: activityController.categories
                                .map(
                                    (item) => DropdownMenuItem<CategoriesModel>(
                                          value: item,
                                          child: Container(
                            ...
                            onChanged: (value) {
                              setState(() {
                                category = value as CategoriesModel;
